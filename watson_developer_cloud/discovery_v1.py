...
class DiscoveryV1(WatsonDeveloperCloudService):
    ...
    def create_environment(self, name, description=None, size=None):
        ...
        :rtype: watson_developer_cloud.discovery_v1.Environment
        """
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return Environment._from_dict(response)

    def delete_environment(self, environment_id):
        """
        Delete environment.

        :param str environment_id: the ID of your environment.
    ...
    def list_environments(self, name=None):
        ...
        :return: A `ListEnvironmentsResponse` object
        :rtype: watson_developer_cloud.discovery_v1.ListEnvironmentsResponse
        """
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return ListEnvironmentsResponse._from_dict(response)
    ...
    def create_configuration(self,
        ...
        :rtype: watson_developer_cloud.discovery_v1.Configuration
        """
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return Configuration._from_dict(response)
    ...
    def delete_configuration(self, environment_id, configuration_id):
        ...
        :param str environment_id: the ID of your environment.
        :param str configuration_id: the ID of your configuration.
        :return: A `dict` containing the deserialized JSON response.
        :rtype: dict
        """
        params = {'version': self.version}
    ...
    def list_configurations(self, environment_id, name=None):
        ...
        :return: A `ListConfigurationsResponse` object
        :rtype: watson_developer_cloud.discovery_v1.ListConfigurationsResponse
        """
        params = {'version': self.version, 'name': name}
        response = self.request(
            method='GET',
            ...
            params=params,
            accept_json=True)
        return ListConfigurationsResponse._from_dict(response)
    ...
    def test_configuration_in_environment(self,
        ...
        :return: A `TestDocument` object
        :rtype: watson_developer_cloud.discovery_v1.TestDocument
        """
        params = {
        ...
        if file:
            if not filename and hasattr(file, 'name'):
                filename = file.name
            if not filename:
                raise WatsonInvalidArgument('filename must be provided')
        ...
        response = self.request(
            ...
            accept_json=True)
        return TestDocument._from_dict(response)
    ...
    def create_collection(self,
        ...
        :param str language: The language of the documents stored in the collection. The value should be in the form of an ISO 639-1 language code.
        :return: A `Collection` object
        :rtype: watson_developer_cloud.discovery_v1.Collection
        """
        params = {'version': self.version}
        data = {
            'name': name,
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return Collection._from_dict(response)
    ...
    def list_collection_fields(self, environment_id, collection_id):
        ...
        :param str environment_id: the ID of your environment.
        :param str collection_id: the ID of your collection.
        :return: A `ListCollectionFieldsResponse` object
        :rtype: watson_developer_cloud.discovery_v1.ListCollectionFieldsResponse
        """
        params = {'version': self.version}
        response = self.request(
            method='GET',
            ...
            params=params,
            accept_json=True)
        return ListCollectionFieldsResponse._from_dict(response)
    ...
    def list_collections(self, environment_id, name=None):
        ...
        :return: A `ListCollectionsResponse` object
        :rtype: watson_developer_cloud.discovery_v1.ListCollectionsResponse
        """
        params = {'version': self.version, 'name': name}
        response = self.request(
            method='GET',
            ...
            params=params,
            accept_json=True)
        return ListCollectionsResponse._from_dict(response)
    ...
    def add_document(self,
        ...
        :param str file_content_type: The content type of file.
        :param str filename: The filename for file.
        :return: A `DocumentAccepted` object
        :rtype: watson_developer_cloud.discovery_v1.DocumentAccepted
        """
        params = {'version': self.version}
        file_tuple = None
        if file:
        ...
        response = self.request(
            ...
            files={'file': file_tuple,
                   'metadata': metadata_tuple},
            accept_json=True)
        return DocumentAccepted._from_dict(response)
    ...
    def delete_document(self, environment_id, collection_id, document_id):
        ...
        :param str environment_id: the ID of your environment.
        :param str collection_id: the ID of your collection.
        :param str document_id: the ID of your document.
        :return: A `dict` containing the deserialized JSON response.
        :rtype: dict
        """
        params = {'version': self.version}
    ...
    def get_document_status(self, environment_id, collection_id, document_id):
        ...
        :rtype: watson_developer_cloud.discovery_v1.DocumentStatus
        """
        params = {'version': self.version}
        response = self.request(
            method='GET',
            ...
            params=params,
            accept_json=True)
        return DocumentStatus._from_dict(response)
    ...
    def query(self,
        ...
        :param int passages_count: The maximum number of passages to return. The search returns fewer passages if the requested total is not found. The default is <tt>10</tt>. The maximum is <tt>100</tt>.
        :param int passages_characters: The approximate number of characters that any one passage will have. The default is <tt>400</tt>. The minimum is <tt>50</tt>. The maximum is <tt>2000</tt>.
        :param bool deduplicate: When <tt>true</tt> and used with a Watson Discovery News collection, duplicate results (based on the contents of the <tt>title</tt> field) are removed. Duplicate comparison is limited to the current query only, <tt>offset</tt> is not considered. Defaults to <tt>false</tt>. This parameter is currently Beta functionality.
        :param str deduplicate_field: When specified, duplicate results based on the field specified are removed from the returned results. Duplicate comparison is limited to the current query only, <tt>offset</tt> is not considered. This parameter is currently Beta functionality.
        :return: A `QueryResponse` object
        :rtype: watson_developer_cloud.discovery_v1.QueryResponse
        """
        params = {
            'version':
            self.version,
            ...
            offset,
            'sort':
            ",".join(sort) if isinstance(sort, list) else sort,
            'highlight':
            highlight,
            'passages.fields':
            ",".join(passages_fields)
            if isinstance(passages_fields, list) else passages_fields,
            'passages.count':
            passages_count,
            'passages.characters':
            passages_characters,
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return QueryResponse._from_dict(response)
    ...
    def query_notices(self,
        ...
        Queries for notices (errors or warnings) that may have been generated by the system. Notices are generated when ingesting documents and performing relevance training. See the [Discovery service documentation](https://www.ibm.com/watson/developercloud/doc/discovery/using.html) for more details on the query language.
        ...
        :param int passages_characters: The approximate number of characters that any one passage will have. The default is <tt>400</tt>. The minimum is <tt>50</tt>. The maximum is <tt>2000</tt>.
        :param str deduplicate_field: When specified, duplicate results based on the field specified are removed from the returned results. Duplicate comparison is limited to the current query only, <tt>offset</tt> is not considered. This parameter is currently Beta functionality.
        :return: A `QueryNoticesResponse` object
        :rtype: watson_developer_cloud.discovery_v1.QueryNoticesResponse
        """
        params = {
            'version':
            self.version,
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return QueryNoticesResponse._from_dict(response)
    ...
    def add_training_data(self,
        ...
        :return: A `TrainingQuery` object
        :rtype: watson_developer_cloud.discovery_v1.TrainingQuery
        """
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return TrainingQuery._from_dict(response)
    ...
    def create_training_example(self,
        ...
        :param int relevance:
        :return: A `TrainingExample` object
        :rtype: watson_developer_cloud.discovery_v1.TrainingExample
        """
        params = {'version': self.version}
        data = {
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return TrainingExample._from_dict(response)
    ...
    def list_training_data(self, environment_id, collection_id):
        ...
        :param str environment_id: the ID of your environment.
        :param str collection_id: the ID of your collection.
        :return: A `TrainingDataSet` object
        :rtype: watson_developer_cloud.discovery_v1.TrainingDataSet
        """
        params = {'version': self.version}
        response = self.request(
            method='GET',
            ...
            params=params,
            accept_json=True)
        return TrainingDataSet._from_dict(response)
...
class Calculation(object):
    ...
    :attr float value: (optional) Value of the aggregation. (For 'max' and 'min' type).
    """
    ...
    def __init__(self,
        ...
        :param float value: (optional) Value of the aggregation. (For 'max' and 'min' type).
        """
        self.value = value
...
class Configuration(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError(
                'Required property \'name\' not present in Configuration dict')
        if 'created' in _dict:
            args['created'] = _dict['created']
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
...
class CreateCollectionRequest(object):
    ...
    :attr str language: (optional) The language of the documents stored in the collection. The value should be in the form of an ISO 639-1 language code.
    """
    ...
    def __init__(self,
        ...
        :param str language: (optional) The language of the documents stored in the collection. The value should be in the form of an ISO 639-1 language code.
        """
        self.name = name
        self.description = description
        self.configuration_id = configuration_id
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError(
                'Required property \'name\' not present in CreateCollectionRequest dict'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
        if 'configuration_id' in _dict:
...
class CreateEnvironmentRequest(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError(
                'Required property \'name\' not present in CreateEnvironmentRequest dict'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
        if 'size' in _dict:
...
class DocumentStatus(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'document_id' in _dict:
            ...
            raise ValueError(
                'Required property \'document_id\' not present in DocumentStatus dict'
            )
        if 'configuration_id' in _dict:
            args['configuration_id'] = _dict['configuration_id']
        else:
            raise ValueError(
                'Required property \'configuration_id\' not present in DocumentStatus dict'
            )
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in DocumentStatus dict'
            )
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        else:
            raise ValueError(
                'Required property \'updated\' not present in DocumentStatus dict'
            )
        if 'status' in _dict:
            args['status'] = _dict['status']
        else:
            raise ValueError(
                'Required property \'status\' not present in DocumentStatus dict'
            )
        if 'status_description' in _dict:
            args['status_description'] = _dict['status_description']
        else:
            raise ValueError(
                'Required property \'status_description\' not present in DocumentStatus dict'
            )
        ...
        if 'notices' in _dict:
            ...
            raise ValueError(
                'Required property \'notices\' not present in DocumentStatus dict'
            )
        return cls(**args)
...
class Enrichment(object):
    ...
    :attr str enrichment_name: Name of the enrichment service to call. Currently the only valid value is `alchemy_language`.
    ...
    def __init__(self,
        ...
        :param str enrichment_name: Name of the enrichment service to call. Currently the only valid value is `alchemy_language`.
    ...
    def _from_dict(cls, _dict):
        ...
        if 'destination_field' in _dict:
            ...
            raise ValueError(
                'Required property \'destination_field\' not present in Enrichment dict'
            )
        if 'source_field' in _dict:
            args['source_field'] = _dict['source_field']
        else:
            raise ValueError(
                'Required property \'source_field\' not present in Enrichment dict'
            )
        ...
        if 'enrichment' in _dict:
            ...
            raise ValueError(
                'Required property \'enrichment\' not present in Enrichment dict'
            )
...
class EnrichmentOptions(object):
    ...
    :attr list[str] extract: (optional) A comma-separated list of analyses that should be applied when using the `alchemy_language` enrichment. See the the service documentation for details on each extract option.  Possible values include:    * entity   * keyword   * taxonomy   * concept   * relation   * doc-sentiment   * doc-emotion   * typed-rels.
    ...
    def __init__(self,
        ...
        :param list[str] extract: (optional) A comma-separated list of analyses that should be applied when using the `alchemy_language` enrichment. See the the service documentation for details on each extract option.  Possible values include:    * entity   * keyword   * taxonomy   * concept   * relation   * doc-sentiment   * doc-emotion   * typed-rels.
    ...
    def _from_dict(cls, _dict):
        ...
        args = {}
        if 'extract' in _dict:
            args['extract'] = _dict['extract']
        if 'sentiment' in _dict:
            args['sentiment'] = _dict['sentiment']
        if 'quotations' in _dict:
            args['quotations'] = _dict['quotations']
        if 'showSourceText' in _dict:
            args['show_source_text'] = _dict['showSourceText']
        if 'hierarchicalTypedRelations' in _dict:
            args['hierarchical_typed_relations'] = _dict[
...
class IndexCapacity(object):
    ...
    def __init__(self, documents=None, disk_usage=None, memory_usage=None):
        """
...
class ListCollectionFieldsResponse(object):
    ...
    :attr list[Field] fields: (optional) An array containing information about each field in the collection.
    """
    ...
    def __init__(self, fields=None):
        ...
        :param list[Field] fields: (optional) An array containing information about each field in the collection.
        """
        self.fields = fields
...
class Notice(object):
    ...
    :attr str notice_id: (optional) Identifies the notice. Many notices may have the same ID. This field exists so that user applications can programmatically identify a notice and take automatic corrective action.
    ...
    def __init__(self,
        ...
        :param str notice_id: (optional) Identifies the notice. Many notices may have the same ID. This field exists so that user applications can programmatically identify a notice and take automatic corrective action.
...
class QueryNoticesResult(object):
    ...
    :attr float score: (optional) The confidence score of the result's analysis. Scores range from 0 to 1, with a higher score indicating greater confidence.
    :attr object metadata: (optional) Metadata of the document.
    """

    def __init__(self, id=None, score=None, metadata=None, **kwargs):
        """
        Initialize a QueryNoticesResult object.

        :param str id: (optional) The unique identifier of the document.
        :param float score: (optional) The confidence score of the result's analysis. Scores range from 0 to 1, with a higher score indicating greater confidence.
...
class QueryPassages(object):
    ...
    :attr float start_offset: (optional) The position of the first character of the extracted passage in the originating field.
    :attr float end_offset: (optional) The position of the last character of the extracted passage in the originating field.
    ...
    def __init__(self,
        ...
        :param float start_offset: (optional) The position of the first character of the extracted passage in the originating field.
        :param float end_offset: (optional) The position of the last character of the extracted passage in the originating field.
...
class UpdateCollectionRequest(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError(
                'Required property \'name\' not present in UpdateCollectionRequest dict'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
        if 'configuration_id' in _dict:
