...
class DiscoveryV1(WatsonDeveloperCloudService):
    ...
    def delete_environment(self, environment_id):
        ...
        if environment_id is None:
            raise WatsonInvalidArgument('environment_id must be provided')
        params = {'version': self.version}
        response = self.request(
            method='DELETE',
    ...
    def list_fields(self, environment_id, collection_ids):
        ...
        if collection_ids is None:
            raise WatsonInvalidArgument('collection_ids must be provided')
        params = {
            'version':
            self.version,
            'collection_ids':
    ...
    def delete_configuration(self, environment_id, configuration_id):
        ...
        if configuration_id is None:
            raise WatsonInvalidArgument('configuration_id must be provided')
        params = {'version': self.version}
        response = self.request(
            method='DELETE',
    ...
    def delete_document(self, environment_id, collection_id, document_id):
        ...
        if document_id is None:
            raise WatsonInvalidArgument('document_id must be provided')
        params = {'version': self.version}
        response = self.request(
            method='DELETE',
    ...
    def create_training_example(self,
        ...
        if collection_id is None:
            raise WatsonInvalidArgument('collection_id must be provided')
        if query_id is None:
            raise WatsonInvalidArgument('query_id must be provided')
        params = {'version': self.version}
        data = {
    ...
    def delete_training_example(self, environment_id, collection_id, query_id,
        ...
        if example_id is None:
            raise WatsonInvalidArgument('example_id must be provided')
        params = {'version': self.version}
        response = self.request(
            method='DELETE',
            url=
...
class QueryNoticesResult(object):
    ...
    def __setattr__(self, name, value):
        properties = {'id', 'score', 'metadata', 'collection_id'}
