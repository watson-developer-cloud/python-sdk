...
class NaturalLanguageUnderstandingV1(WatsonDeveloperCloudService):
    """Client for the Natural Language Understanding service."""
    ...
    def analyze(self,
        ...
        :return: A `AnalysisResults` object
        :rtype: natural_language_understanding_v1.AnalysisResults
        """
        if features is None:
            raise WatsonInvalidArgument('features must be provided')
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return AnalysisResults._from_dict(response)
    ...
    def list_models(self):
        ...
        :return: A `ListModelsResults` object
        :rtype: natural_language_understanding_v1.ListModelsResults
        """
        params = {'version': self.version}
        response = self.request(
            method='GET', url='/v1/models', params=params, accept_json=True)
        return ListModelsResults._from_dict(response)
...
class EntitiesOptions(object):
    ...
    def __init__(self, limit=None, model=None, sentiment=None, emotion=None):
        """
...
class MetadataResult(object):
    ...
    def __init__(self, authors=None, publication_date=None, title=None):
        """
