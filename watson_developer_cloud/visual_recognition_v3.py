...
class VisualRecognitionV3(WatsonDeveloperCloudService):
    ...
    def classify(self,
        ...
        :return: A `ClassifiedImages` object
        :rtype: watson_developer_cloud.visual_recognition_v3.ClassifiedImages
        """
        ...
        if images_file:
            ...
            images_file_tuple = (images_file.name, images_file, mime_type)
        ...
        response = self.request(
            ...
            accept_json=True)
        return ClassifiedImages._from_dict(response)
    ...
    def detect_faces(self,
        ...
        :param str images_file_content_type: The content type of images_file.
        :return: A `DetectedFaces` object
        :rtype: watson_developer_cloud.visual_recognition_v3.DetectedFaces
        """
        params = {'version': self.version}
        images_file_tuple = None
        if images_file:
        ...
        response = self.request(
            ...
            accept_json=True)
        return DetectedFaces._from_dict(response)
    ...
    def list_classifiers(self, verbose=None):
        ...
        :return: A `Classifiers` object
        :rtype: watson_developer_cloud.visual_recognition_v3.Classifiers
        """
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return Classifiers._from_dict(response)
    ...
    def create_collection(self, name, disregard=None):
        """
        ...
        :rtype: watson_developer_cloud.visual_recognition_v3.Collection
        """
        if name is None:
            raise WatsonInvalidArgument('name must be provided')
        params = {'version': self.version}
        ...
        if disregard:
            ...
            disregard_tuple = (disregard.name, disregard, mime_type)
        response = self.request(
            method='POST',
            url='/v3/collections',
            params=params,
    ...
    def find_similar_images(self,
        ...
        :return: A `SimilarImages` object
        :rtype: watson_developer_cloud.visual_recognition_v3.SimilarImages
        """
        if collection_id is None:
            raise WatsonInvalidArgument('collection_id must be provided')
        if image_file is None:
            raise WatsonInvalidArgument('image_file must be provided')
        params = {'version': self.version, 'limit': limit}
        mime_type = image_file_content_type or 'application/octet-stream'
        image_file_tuple = (image_file.name, image_file, mime_type)
        response = self.request(
            method='POST',
            ...
            accept_json=True)
        return SimilarImages._from_dict(response)
    ...
    def list_collections(self):
        ...
        :rtype: watson_developer_cloud.visual_recognition_v3.Collections
        """
        params = {'version': self.version}
        response = self.request(
            method='GET',
            ...
            params=params,
            accept_json=True)
        return Collections._from_dict(response)
    ...
    def add_collection_image(self,
        ...
        :param str image_file_content_type: The content type of image_file.
        :return: A `CollectionImages` object
        :rtype: watson_developer_cloud.visual_recognition_v3.CollectionImages
        """
        if collection_id is None:
            raise WatsonInvalidArgument('collection_id must be provided')
        if image_file is None:
        ...
        if metadata:
            mime_type = 'application/octet-stream'
            metadata_tuple = (metadata.name, metadata, mime_type)
        response = self.request(
            method='POST',
            ...
            accept_json=True)
        return CollectionImages._from_dict(response)
    ...
    def delete_collection_image(self, collection_id, image_id):
        ...
        if collection_id is None:
            raise WatsonInvalidArgument('collection_id must be provided')
        if image_id is None:
            raise WatsonInvalidArgument('image_id must be provided')
        params = {'version': self.version}
        self.request(
            method='DELETE',
    ...
    def get_collection_image(self, collection_id, image_id):
        ...
        :param str collection_id: The ID of your collection.
        :param str image_id: The ID of your image.
        :return: A `CollectionImage` object
        :rtype: watson_developer_cloud.visual_recognition_v3.CollectionImage
        """
        if collection_id is None:
            raise WatsonInvalidArgument('collection_id must be provided')
        if image_id is None:
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return CollectionImage._from_dict(response)
...
class Class(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'class' in _dict:
            ...
            raise ValueError(
                'Required property \'class\' not present in Class dict')
        return cls(**args)
...
class ClassResult(object):
    ...
    :attr str class_name: The name of the class.
    :attr float score: (optional) The score of a class identified in an image. Scores range from 0-1, with a higher score indicating greater correlation.
    :attr str type_hierarchy: (optional) Type hierarchy, e.g. 'People/Leaders/Presidents/USA/Barack Obama'. Only included if found.
    """
    ...
    def __init__(self, class_name, score=None, type_hierarchy=None):
        ...
        :param str class_name: The name of the class.
        :param float score: (optional) The score of a class identified in an image. Scores range from 0-1, with a higher score indicating greater correlation.
        :param str type_hierarchy: (optional) Type hierarchy, e.g. 'People/Leaders/Presidents/USA/Barack Obama'. Only included if found.
        """
        self.class_name = class_name
        self.score = score
    ...
    def _from_dict(cls, _dict):
        ...
        if 'class' in _dict:
            ...
            raise ValueError(
                'Required property \'class\' not present in ClassResult dict')
        if 'score' in _dict:
...
class ClassifiedImage(object):
    ...
    :attr str source_url: (optional) Source image URL. Omitted if the image was uploaded. This is the URL as given to the service, before any redirects.
    :attr str resolved_url: (optional) Fully-resolved image URL. Omitted if the image was uploaded. Redirects are followed, for example with URL shorteners.
    :attr str image: (optional) Relative path of the image file if uploaded directly (e.g., inside a zip file). Omitted if image was passed by URL.
    ...
    def __init__(self,
        ...
        :param str source_url: (optional) Source image URL. Omitted if the image was uploaded. This is the URL as given to the service, before any redirects.
        :param str resolved_url: (optional) Fully-resolved image URL. Omitted if the image was uploaded. Redirects are followed, for example with URL shorteners.
        :param str image: (optional) Relative path of the image file if uploaded directly (e.g., inside a zip file). Omitted if image was passed by URL.
    ...
    def _from_dict(cls, _dict):
        ...
        if 'classifiers' in _dict:
            ...
            raise ValueError(
                'Required property \'classifiers\' not present in ClassifiedImage dict'
            )
        return cls(**args)
...
class ClassifiedImages(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'images' in _dict:
            ...
            raise ValueError(
                'Required property \'images\' not present in ClassifiedImages dict'
            )
...
class Classifier(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'classifier_id' in _dict:
            ...
            raise ValueError(
                'Required property \'classifier_id\' not present in Classifier dict'
            )
        if 'name' in _dict:
            args['name'] = _dict['name']
        else:
            raise ValueError(
                'Required property \'name\' not present in Classifier dict')
        if 'owner' in _dict:
...
class ClassifierResult(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError(
                'Required property \'name\' not present in ClassifierResult dict'
            )
        if 'classifier_id' in _dict:
            args['classifier_id'] = _dict['classifier_id']
        else:
            raise ValueError(
                'Required property \'classifier_id\' not present in ClassifierResult dict'
            )
        if 'classes' in _dict:
            args['classes'] = [
            ...
            raise ValueError(
                'Required property \'classes\' not present in ClassifierResult dict'
            )
        return cls(**args)
...
class Classifiers(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'classifiers' in _dict:
            ...
            raise ValueError(
                'Required property \'classifiers\' not present in Classifiers dict'
            )
        return cls(**args)
...
class Collection(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError(
                'Required property \'name\' not present in Collection dict')
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in Collection dict')
        if 'images' in _dict:
            args['images'] = _dict['images']
        else:
            raise ValueError(
                'Required property \'images\' not present in Collection dict')
        if 'status' in _dict:
            args['status'] = _dict['status']
        else:
            raise ValueError(
                'Required property \'status\' not present in Collection dict')
        if 'capacity' in _dict:
            args['capacity'] = _dict['capacity']
        else:
            raise ValueError(
                'Required property \'capacity\' not present in Collection dict'
            )
        return cls(**args)
...
class CollectionImage(object):
    ...
    :attr str image_id: The unique ID of the image. Save this to add or remove it from the collection.
    ...
    def __init__(self, image_id, created, image_file, metadata, score=None):
        ...
        :param str image_id: The unique ID of the image. Save this to add or remove it from the collection.
    ...
    def _from_dict(cls, _dict):
        ...
        if 'image_id' in _dict:
            ...
            raise ValueError(
                'Required property \'image_id\' not present in CollectionImage dict'
            )
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in CollectionImage dict'
            )
        if 'image_file' in _dict:
            args['image_file'] = _dict['image_file']
        else:
            raise ValueError(
                'Required property \'image_file\' not present in CollectionImage dict'
            )
        if 'metadata' in _dict:
            args['metadata'] = _dict['metadata']
        else:
            raise ValueError(
                'Required property \'metadata\' not present in CollectionImage dict'
            )
        if 'score' in _dict:
            args['score'] = _dict['score']
        return cls(**args)
...
class CollectionImages(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'images' in _dict:
            ...
            raise ValueError(
                'Required property \'images\' not present in CollectionImages dict'
            )
        if 'images_processed' in _dict:
            args['images_processed'] = _dict['images_processed']
        return cls(**args)
...
class Collections(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'collections' in _dict:
            ...
            raise ValueError(
                'Required property \'collections\' not present in Collections dict'
            )
        return cls(**args)
...
class DetectedFaces(object):
    ...
    :attr list[WarningInfo] warnings: (optional) An array containing informaton about what might cause the output to be less than optimal. For example, a call with a corrupt .zip file and a list of image URLs will still complete but will not have the expected output. Omitted if there are no warnings.
    """
    ...
    def __init__(self, images, images_processed=None, warnings=None):
        ...
        :param list[WarningInfo] warnings: (optional) An array containing informaton about what might cause the output to be less than optimal. For example, a call with a corrupt .zip file and a list of image URLs will still complete but will not have the expected output. Omitted if there are no warnings.
        """
        self.images_processed = images_processed
        self.images = images
        self.warnings = warnings
    ...
    def _from_dict(cls, _dict):
        ...
        if 'images' in _dict:
            ...
            raise ValueError(
                'Required property \'images\' not present in DetectedFaces dict'
            )
        if 'warnings' in _dict:
            args['warnings'] = [
                WarningInfo._from_dict(x) for x in _dict['warnings']
...
class ErrorInfo(object):
    ...
    :attr str error_id: Codified error string, like 'input_error'.
    :attr str description: Human-readable error string, like 'Ignoring image with no valid data.'.
    """
    ...
    def __init__(self, error_id, description):
        ...
        :param str error_id: Codified error string, like 'input_error'.
        :param str description: Human-readable error string, like 'Ignoring image with no valid data.'.
        """
    ...
    def _from_dict(cls, _dict):
        ...
        if 'error_id' in _dict:
            ...
            raise ValueError(
                'Required property \'error_id\' not present in ErrorInfo dict')
        if 'description' in _dict:
            args['description'] = _dict['description']
        else:
            raise ValueError(
                'Required property \'description\' not present in ErrorInfo dict'
            )
        return cls(**args)
...
class Face(object):
    ...
    :attr FaceFaceLocation face_location: (optional)
    ...
    def __init__(self,
        ...
        :param FaceFaceLocation face_location: (optional)
    ...
    def _from_dict(cls, _dict):
        ...
        if 'face_location' in _dict:
            args['face_location'] = FaceFaceLocation._from_dict(
                _dict['face_location'])
...
class FaceFaceLocation(object):
    ...
    def __init__(self, width, height, left, top):
        """
        Initialize a FaceFaceLocation object.
    ...
    @classmethod
    def _from_dict(cls, _dict):
        """Initialize a FaceFaceLocation object from a json dictionary."""
        args = {}
        if 'width' in _dict:
            args['width'] = _dict['width']
        else:
            raise ValueError(
                'Required property \'width\' not present in FaceFaceLocation dict'
            )
        if 'height' in _dict:
            args['height'] = _dict['height']
        else:
            raise ValueError(
                'Required property \'height\' not present in FaceFaceLocation dict'
            )
        if 'left' in _dict:
            args['left'] = _dict['left']
        else:
            raise ValueError(
                'Required property \'left\' not present in FaceFaceLocation dict'
            )
        if 'top' in _dict:
            args['top'] = _dict['top']
        else:
            raise ValueError(
                'Required property \'top\' not present in FaceFaceLocation dict'
            )
        return cls(**args)
    ...
    def __str__(self):
        """Return a `str` version of this FaceFaceLocation object."""
        return json.dumps(self._to_dict(), indent=2)
...
class FaceGender(object):
    ...
    :attr str gender: 'MALE' or 'FEMALE'.
    :attr float score: (optional) The score of a class identified in an image. Scores range from 0-1, with a higher score indicating greater correlation.
    """
    ...
    def __init__(self, gender, score=None):
        ...
        :param str gender: 'MALE' or 'FEMALE'.
        :param float score: (optional) The score of a class identified in an image. Scores range from 0-1, with a higher score indicating greater correlation.
        """
        self.gender = gender
        self.score = score
    ...
    def _from_dict(cls, _dict):
        ...
        if 'gender' in _dict:
            ...
            raise ValueError(
                'Required property \'gender\' not present in FaceGender dict')
        if 'score' in _dict:
            args['score'] = _dict['score']
        return cls(**args)
...
class FaceIdentity(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError(
                'Required property \'name\' not present in FaceIdentity dict')
        if 'score' in _dict:
            args['score'] = _dict['score']
        if 'type_hierarchy' in _dict:
            args['type_hierarchy'] = _dict['type_hierarchy']
...
class ImageWithFaces(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'faces' in _dict:
            ...
            raise ValueError(
                'Required property \'faces\' not present in ImageWithFaces dict'
            )
        return cls(**args)
...
class SimilarImages(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'similar_images' in _dict:
            ...
            raise ValueError(
                'Required property \'similar_images\' not present in SimilarImages dict'
            )
        if 'images_processed' in _dict:
            args['images_processed'] = _dict['images_processed']
        else:
            raise ValueError(
                'Required property \'images_processed\' not present in SimilarImages dict'
            )
        return cls(**args)
...
class WarningInfo(object):
    ...
    :attr str warning_id: Codified warning string, like 'limit_reached'.
    :attr str description: Human-readable warning string, like 'Max number of images (100) reached.'.
    """
    ...
    def __init__(self, warning_id, description):
        ...
        :param str warning_id: Codified warning string, like 'limit_reached'.
        :param str description: Human-readable warning string, like 'Max number of images (100) reached.'.
        """
    ...
    def _from_dict(cls, _dict):
        ...
        if 'warning_id' in _dict:
            ...
            raise ValueError(
                'Required property \'warning_id\' not present in WarningInfo dict'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
        else:
            raise ValueError(
                'Required property \'description\' not present in WarningInfo dict'
            )
        return cls(**args)
