...
class AlchemyVisionV1(WatsonService):
    ...
    def get_image_keywords(self, image_file=None, image_url=None,
                           knowledge_graph=False, force_show_all=False):
    ...
    def recognize_faces(self, image_file=None, image_url=None,
