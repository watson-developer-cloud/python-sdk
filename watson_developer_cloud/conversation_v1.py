...
class ConversationV1(WatsonDeveloperCloudService):
    ...
    def delete_workspace(self, workspace_id):
        ...
        if workspace_id is None:
            raise WatsonInvalidArgument('workspace_id must be provided')
        params = {'version': self.version}
        response = self.request(
            method='DELETE',
    ...
    def create_intent(self,
        ...
        if workspace_id is None:
            raise WatsonInvalidArgument('workspace_id must be provided')
        if intent is None:
            raise WatsonInvalidArgument('intent must be provided')
    ...
    def create_example(self, workspace_id, intent, text):
        ...
        if intent is None:
            raise WatsonInvalidArgument('intent must be provided')
        if text is None:
            raise WatsonInvalidArgument('text must be provided')
        params = {'version': self.version}
        data = {'text': text}
        response = self.request(
            method='POST',
    ...
    def create_entity(self,
        ...
        if workspace_id is None:
            raise WatsonInvalidArgument('workspace_id must be provided')
        if entity is None:
            raise WatsonInvalidArgument('entity must be provided')
    ...
    def create_value(self,
        ...
        if entity is None:
            raise WatsonInvalidArgument('entity must be provided')
        if value is None:
            raise WatsonInvalidArgument('value must be provided')
        params = {'version': self.version}
        data = {
            'value': value,
            'metadata': metadata,
    ...
    def create_synonym(self, workspace_id, entity, value, synonym):
        ...
        if value is None:
            raise WatsonInvalidArgument('value must be provided')
        if synonym is None:
            raise WatsonInvalidArgument('synonym must be provided')
        params = {'version': self.version}
    ...
    def create_dialog_node(self,
        ...
        if dialog_node is None:
            raise WatsonInvalidArgument('dialog_node must be provided')
    ...
    def update_dialog_node(self,
        ...
        if new_dialog_node is None:
            raise WatsonInvalidArgument('new_dialog_node must be provided')
...
class UpdateDialogNode(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'dialog_node' in _dict:
            ...
            raise ValueError(
                'Required property \'dialog_node\' not present in UpdateDialogNode JSON'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
        if 'conditions' in _dict:
