...
class ConversationV1(WatsonDeveloperCloudService):
    ...
    def create_workspace(self,
        ...
        :rtype: watson_developer_cloud.conversation_v1.Workspace
        """
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return Workspace._from_dict(response)
    ...
    def delete_workspace(self, workspace_id):
        ...
        :return: A `dict` containing the deserialized JSON response.
        :rtype: dict
        """
        params = {'version': self.version}
        response = self.request(
    ...
    def get_workspace(self, workspace_id, export=None):
        ...
        :return: A `WorkspaceExport` object
        :rtype: watson_developer_cloud.conversation_v1.WorkspaceExport
        """
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return WorkspaceExport._from_dict(response)
    ...
    def list_workspaces(self,
        ...
        :return: A `WorkspaceCollection` object
        :rtype: watson_developer_cloud.conversation_v1.WorkspaceCollection
        """
        params = {
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return WorkspaceCollection._from_dict(response)
    ...
    def message(self,
        ...
        :rtype: watson_developer_cloud.conversation_v1.MessageResponse
        """
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return MessageResponse._from_dict(response)
    ...
    def create_intent(self,
        ...
        :return: A `Intent` object
        :rtype: watson_developer_cloud.conversation_v1.Intent
        """
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return Intent._from_dict(response)
    ...
    def get_intent(self, workspace_id, intent, export=None):
        ...
        :param str intent: The intent name (for example, `pizza_order`).
        :param bool export: Whether to include all element content in the returned data. If export=`false`, the returned data includes only information about the element itself. If export=`true`, all content, including subelements, is included. The default value is `false`.
        :return: A `IntentExport` object
        :rtype: watson_developer_cloud.conversation_v1.IntentExport
        """
        params = {'version': self.version, 'export': export}
        response = self.request(
            method='GET',
            ...
            params=params,
            accept_json=True)
        return IntentExport._from_dict(response)
    ...
    def list_intents(self,
        ...
        :param str sort: Sorts the response according to the value of the specified property, in ascending or descending order.
        :param str cursor: A token identifying the last value from the previous page of results.
        :return: A `IntentCollection` object
        :rtype: watson_developer_cloud.conversation_v1.IntentCollection
        """
        params = {
            'version': self.version,
            'export': export,
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return IntentCollection._from_dict(response)
    ...
    def create_example(self, workspace_id, intent, text):
        ...
        :rtype: watson_developer_cloud.conversation_v1.Example
        """
        params = {'version': self.version}
        data = {'text': text}
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return Example._from_dict(response)
    ...
    def list_examples(self,
        ...
        :param str sort: Sorts the response according to the value of the specified property, in ascending or descending order.
        :param str cursor: A token identifying the last value from the previous page of results.
        :return: A `ExampleCollection` object
        :rtype: watson_developer_cloud.conversation_v1.ExampleCollection
        """
        params = {
            'version': self.version,
            'page_limit': page_limit,
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return ExampleCollection._from_dict(response)
    ...
    def create_entity(self,
        ...
        :rtype: watson_developer_cloud.conversation_v1.Entity
        """
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return Entity._from_dict(response)
    ...
    def get_entity(self, workspace_id, entity, export=None):
        ...
        :param str entity: The name of the entity.
        :param bool export: Whether to include all element content in the returned data. If export=`false`, the returned data includes only information about the element itself. If export=`true`, all content, including subelements, is included. The default value is `false`.
        :return: A `EntityExport` object
        :rtype: watson_developer_cloud.conversation_v1.EntityExport
        """
        params = {'version': self.version, 'export': export}
        response = self.request(
            method='GET',
            ...
            params=params,
            accept_json=True)
        return EntityExport._from_dict(response)
    ...
    def list_entities(self,
        ...
        :param str sort: Sorts the response according to the value of the specified property, in ascending or descending order.
        :param str cursor: A token identifying the last value from the previous page of results.
        :return: A `EntityCollection` object
        :rtype: watson_developer_cloud.conversation_v1.EntityCollection
        """
        params = {
            'version': self.version,
            'export': export,
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return EntityCollection._from_dict(response)
    ...
    def create_value(self,
        ...
        :rtype: watson_developer_cloud.conversation_v1.Value
        """
        params = {'version': self.version}
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return Value._from_dict(response)
    ...
    def get_value(self, workspace_id, entity, value, export=None):
        ...
        :param str value: The text of the entity value.
        :param bool export: Whether to include all element content in the returned data. If export=`false`, the returned data includes only information about the element itself. If export=`true`, all content, including subelements, is included. The default value is `false`.
        :return: A `ValueExport` object
        :rtype: watson_developer_cloud.conversation_v1.ValueExport
        """
        params = {'version': self.version, 'export': export}
        response = self.request(
            method='GET',
            ...
            params=params,
            accept_json=True)
        return ValueExport._from_dict(response)
    ...
    def list_values(self,
        ...
        :param str sort: Sorts the response according to the value of the specified property, in ascending or descending order.
        :param str cursor: A token identifying the last value from the previous page of results.
        :return: A `ValueCollection` object
        :rtype: watson_developer_cloud.conversation_v1.ValueCollection
        """
        params = {
            'version': self.version,
            'export': export,
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return ValueCollection._from_dict(response)
    ...
    def create_synonym(self, workspace_id, entity, value, synonym):
        ...
        :return: A `Synonym` object
        :rtype: watson_developer_cloud.conversation_v1.Synonym
        """
        params = {'version': self.version}
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return Synonym._from_dict(response)
    ...
    def list_synonyms(self,
        ...
        :param str sort: Sorts the response according to the value of the specified property, in ascending or descending order.
        :param str cursor: A token identifying the last value from the previous page of results.
        :return: A `SynonymCollection` object
        :rtype: watson_developer_cloud.conversation_v1.SynonymCollection
        """
        params = {
            'version': self.version,
            'page_limit': page_limit,
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return SynonymCollection._from_dict(response)
    ...
    def create_dialog_node(self,
        ...
        :return: A `DialogNode` object
        :rtype: watson_developer_cloud.conversation_v1.DialogNode
        """
        ...
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return DialogNode._from_dict(response)
    ...
    def list_dialog_nodes(self,
        ...
        :param str sort: Sorts the response according to the value of the specified property, in ascending or descending order.
        :param str cursor: A token identifying the last value from the previous page of results.
        :return: A `DialogNodeCollection` object
        :rtype: watson_developer_cloud.conversation_v1.DialogNodeCollection
        """
        params = {
            'version': self.version,
            'page_limit': page_limit,
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return DialogNodeCollection._from_dict(response)
    ...
    def list_logs(self,
        ...
        :param int page_limit: The number of records to return in each page of results. The default page limit is 100.
        :param str cursor: A token identifying the last value from the previous page of results.
        :return: A `LogCollection` object
        :rtype: watson_developer_cloud.conversation_v1.LogCollection
        """
        params = {
            'version': self.version,
            'sort': sort,
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return LogCollection._from_dict(response)
    ...
    def create_counterexample(self, workspace_id, text):
        ...
        :return: A `Counterexample` object
        :rtype: watson_developer_cloud.conversation_v1.Counterexample
        """
        params = {'version': self.version}
        data = {'text': text}
        response = self.request(
            ...
            json=data,
            accept_json=True)
        return Counterexample._from_dict(response)
    ...
    def list_counterexamples(self,
        ...
        :param str sort: Sorts the response according to the value of the specified property, in ascending or descending order.
        :param str cursor: A token identifying the last value from the previous page of results.
        :return: A `CounterexampleCollection` object
        :rtype: watson_developer_cloud.conversation_v1.CounterexampleCollection
        """
        params = {
            'version': self.version,
            'page_limit': page_limit,
        ...
        response = self.request(
            ...
            params=params,
            accept_json=True)
        return CounterexampleCollection._from_dict(response)
...
class Context(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'conversation_id' in _dict:
            ...
            raise ValueError(
                'Required property \'conversation_id\' not present in Context dict'
            )
        if 'system' in _dict:
            ...
            raise ValueError(
                'Required property \'system\' not present in Context dict')
        args.update(xtra)
        return cls(**args)
...
class Counterexample(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'text' in _dict:
            ...
            raise ValueError(
                'Required property \'text\' not present in Counterexample dict'
            )
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in Counterexample dict'
            )
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        else:
            raise ValueError(
                'Required property \'updated\' not present in Counterexample dict'
            )
        return cls(**args)
...
class CounterexampleCollection(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'counterexamples' in _dict:
            ...
            raise ValueError(
                'Required property \'counterexamples\' not present in CounterexampleCollection dict'
            )
        if 'pagination' in _dict:
            args['pagination'] = Pagination._from_dict(_dict['pagination'])
        else:
            raise ValueError(
                'Required property \'pagination\' not present in CounterexampleCollection dict'
            )
        return cls(**args)
...
class CreateCounterexample(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'text' in _dict:
            ...
            raise ValueError(
                'Required property \'text\' not present in CreateCounterexample dict'
            )
        return cls(**args)
...
class CreateDialogNode(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'dialog_node' in _dict:
            ...
            raise ValueError(
                'Required property \'dialog_node\' not present in CreateDialogNode dict'
            )
...
class CreateEntity(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'entity' in _dict:
            ...
            raise ValueError(
                'Required property \'entity\' not present in CreateEntity dict'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
        if 'metadata' in _dict:
...
class CreateExample(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'text' in _dict:
            ...
            raise ValueError(
                'Required property \'text\' not present in CreateExample dict')
        return cls(**args)
...
class CreateIntent(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'intent' in _dict:
            ...
            raise ValueError(
                'Required property \'intent\' not present in CreateIntent dict'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
...
class CreateSynonym(object):
    ...
    :attr str synonym: The text of the synonym.
    """
    ...
    def _from_dict(cls, _dict):
        ...
        args = {}
        if 'synonym' in _dict:
            args['synonym'] = _dict['synonym']
        else:
            raise ValueError(
                'Required property \'synonym\' not present in CreateSynonym dict'
            )
        return cls(**args)
...
class CreateValue(object):
    ...
    def __init__(self, value, metadata=None, synonyms=None):
        """
    ...
    def _from_dict(cls, _dict):
        ...
        if 'value' in _dict:
            ...
            raise ValueError(
                'Required property \'value\' not present in CreateValue dict')
        if 'metadata' in _dict:
            args['metadata'] = _dict['metadata']
...
class CreateWorkspace(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'intents' in _dict:
            args['intents'] = [
                CreateIntent._from_dict(x) for x in _dict['intents']
            ]
        if 'entities' in _dict:
            args['entities'] = [
                CreateEntity._from_dict(x) for x in _dict['entities']
            ]
        if 'dialog_nodes' in _dict:
            args['dialog_nodes'] = [
                CreateDialogNode._from_dict(x) for x in _dict['dialog_nodes']
            ]
        if 'counterexamples' in _dict:
            args['counterexamples'] = [
                CreateCounterexample._from_dict(x)
                for x in _dict['counterexamples']
            ]
        if 'metadata' in _dict:
            args['metadata'] = _dict['metadata']
...
class DialogNode(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'dialog_node' in _dict:
            ...
            raise ValueError(
                'Required property \'dialog_node\' not present in DialogNode dict'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
        else:
            raise ValueError(
                'Required property \'description\' not present in DialogNode dict'
            )
        if 'conditions' in _dict:
            args['conditions'] = _dict['conditions']
        else:
            raise ValueError(
                'Required property \'conditions\' not present in DialogNode dict'
            )
        if 'parent' in _dict:
            args['parent'] = _dict['parent']
        else:
            raise ValueError(
                'Required property \'parent\' not present in DialogNode dict')
        if 'previous_sibling' in _dict:
            args['previous_sibling'] = _dict['previous_sibling']
        else:
            raise ValueError(
                'Required property \'previous_sibling\' not present in DialogNode dict'
            )
        if 'output' in _dict:
            args['output'] = _dict['output']
        else:
            raise ValueError(
                'Required property \'output\' not present in DialogNode dict')
        if 'context' in _dict:
            args['context'] = _dict['context']
        else:
            raise ValueError(
                'Required property \'context\' not present in DialogNode dict')
        if 'metadata' in _dict:
            args['metadata'] = _dict['metadata']
        else:
            raise ValueError(
                'Required property \'metadata\' not present in DialogNode dict'
            )
        if 'next_step' in _dict:
            args['next_step'] = DialogNodeNextStep._from_dict(
                _dict['next_step'])
            ...
            raise ValueError(
                'Required property \'next_step\' not present in DialogNode dict'
            )
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in DialogNode dict')
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        if 'actions' in _dict:
            args['actions'] = [
        ...
        if 'title' in _dict:
            ...
            raise ValueError(
                'Required property \'title\' not present in DialogNode dict')
        if 'type' in _dict:
            args['node_type'] = _dict['type']
        if 'event_name' in _dict:
            args['event_name'] = _dict['event_name']
...
class DialogNodeAction(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError(
                'Required property \'name\' not present in DialogNodeAction dict'
            )
        if 'type' in _dict:
        ...
        if 'result_variable' in _dict:
            ...
            raise ValueError(
                'Required property \'result_variable\' not present in DialogNodeAction dict'
            )
        return cls(**args)
...
class DialogNodeCollection(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'dialog_nodes' in _dict:
            ...
            raise ValueError(
                'Required property \'dialog_nodes\' not present in DialogNodeCollection dict'
            )
        if 'pagination' in _dict:
            args['pagination'] = Pagination._from_dict(_dict['pagination'])
        else:
            raise ValueError(
                'Required property \'pagination\' not present in DialogNodeCollection dict'
            )
        return cls(**args)
...
class DialogNodeNextStep(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'behavior' in _dict:
            ...
            raise ValueError(
                'Required property \'behavior\' not present in DialogNodeNextStep dict'
            )
        if 'dialog_node' in _dict:
            args['dialog_node'] = _dict['dialog_node']
...
class Entity(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'entity' in _dict:
            ...
            raise ValueError(
                'Required property \'entity\' not present in Entity dict')
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in Entity dict')
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        else:
            raise ValueError(
                'Required property \'updated\' not present in Entity dict')
        if 'description' in _dict:
            args['description'] = _dict['description']
        if 'metadata' in _dict:
            args['metadata'] = _dict['metadata']
...
class EntityCollection(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'entities' in _dict:
            ...
            raise ValueError(
                'Required property \'entities\' not present in EntityCollection dict'
            )
        if 'pagination' in _dict:
            args['pagination'] = Pagination._from_dict(_dict['pagination'])
        else:
            raise ValueError(
                'Required property \'pagination\' not present in EntityCollection dict'
            )
        return cls(**args)
...
class EntityExport(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'entity' in _dict:
            ...
            raise ValueError(
                'Required property \'entity\' not present in EntityExport dict'
            )
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in EntityExport dict'
            )
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        else:
            raise ValueError(
                'Required property \'updated\' not present in EntityExport dict'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
        if 'metadata' in _dict:
...
class Example(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'text' in _dict:
            ...
            raise ValueError(
                'Required property \'text\' not present in Example dict')
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in Example dict')
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        else:
            raise ValueError(
                'Required property \'updated\' not present in Example dict')
        return cls(**args)
...
class ExampleCollection(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'examples' in _dict:
            ...
            raise ValueError(
                'Required property \'examples\' not present in ExampleCollection dict'
            )
        if 'pagination' in _dict:
            args['pagination'] = Pagination._from_dict(_dict['pagination'])
        else:
            raise ValueError(
                'Required property \'pagination\' not present in ExampleCollection dict'
            )
        return cls(**args)
...
class InputData(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'text' in _dict:
            ...
            raise ValueError(
                'Required property \'text\' not present in InputData dict')
        return cls(**args)
...
class Intent(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'intent' in _dict:
            ...
            raise ValueError(
                'Required property \'intent\' not present in Intent dict')
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in Intent dict')
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        else:
            raise ValueError(
                'Required property \'updated\' not present in Intent dict')
        if 'description' in _dict:
            args['description'] = _dict['description']
        return cls(**args)
...
class IntentCollection(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'intents' in _dict:
            ...
            raise ValueError(
                'Required property \'intents\' not present in IntentCollection dict'
            )
        if 'pagination' in _dict:
            args['pagination'] = Pagination._from_dict(_dict['pagination'])
        else:
            raise ValueError(
                'Required property \'pagination\' not present in IntentCollection dict'
            )
        return cls(**args)
...
class IntentExport(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'intent' in _dict:
            ...
            raise ValueError(
                'Required property \'intent\' not present in IntentExport dict'
            )
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in IntentExport dict'
            )
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        else:
            raise ValueError(
                'Required property \'updated\' not present in IntentExport dict'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
        if 'examples' in _dict:
...
class LogCollection(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'logs' in _dict:
            ...
            raise ValueError(
                'Required property \'logs\' not present in LogCollection dict')
        if 'pagination' in _dict:
            args['pagination'] = LogPagination._from_dict(_dict['pagination'])
        else:
            raise ValueError(
                'Required property \'pagination\' not present in LogCollection dict'
            )
        return cls(**args)
...
class LogExport(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'request' in _dict:
            ...
            raise ValueError(
                'Required property \'request\' not present in LogExport dict')
        if 'response' in _dict:
            args['response'] = MessageResponse._from_dict(_dict['response'])
        else:
            raise ValueError(
                'Required property \'response\' not present in LogExport dict')
        if 'log_id' in _dict:
            args['log_id'] = _dict['log_id']
        else:
            raise ValueError(
                'Required property \'log_id\' not present in LogExport dict')
        if 'request_timestamp' in _dict:
            args['request_timestamp'] = _dict['request_timestamp']
        else:
            raise ValueError(
                'Required property \'request_timestamp\' not present in LogExport dict'
            )
        if 'response_timestamp' in _dict:
            args['response_timestamp'] = _dict['response_timestamp']
        else:
            raise ValueError(
                'Required property \'response_timestamp\' not present in LogExport dict'
            )
        return cls(**args)
...
class LogMessage(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'level' in _dict:
            ...
            raise ValueError(
                'Required property \'level\' not present in LogMessage dict')
        if 'msg' in _dict:
            args['msg'] = _dict['msg']
            del xtra['msg']
        else:
            raise ValueError(
                'Required property \'msg\' not present in LogMessage dict')
        args.update(xtra)
        return cls(**args)
...
class MessageResponse(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'intents' in _dict:
            ...
            raise ValueError(
                'Required property \'intents\' not present in MessageResponse dict'
            )
        if 'entities' in _dict:
            args['entities'] = [
                RuntimeEntity._from_dict(x) for x in _dict['entities']
            ...
            raise ValueError(
                'Required property \'entities\' not present in MessageResponse dict'
            )
        if 'alternate_intents' in _dict:
            args['alternate_intents'] = _dict['alternate_intents']
        ...
        if 'context' in _dict:
            ...
            raise ValueError(
                'Required property \'context\' not present in MessageResponse dict'
            )
        if 'output' in _dict:
            args['output'] = OutputData._from_dict(_dict['output'])
            del xtra['output']
            ...
            raise ValueError(
                'Required property \'output\' not present in MessageResponse dict'
            )
        args.update(xtra)
        return cls(**args)
...
class OutputData(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'log_messages' in _dict:
            ...
            raise ValueError(
                'Required property \'log_messages\' not present in OutputData dict'
            )
        if 'text' in _dict:
            args['text'] = _dict['text']
            del xtra['text']
            ...
            raise ValueError(
                'Required property \'text\' not present in OutputData dict')
...
class Pagination(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'refresh_url' in _dict:
            ...
            raise ValueError(
                'Required property \'refresh_url\' not present in Pagination dict'
            )
        if 'next_url' in _dict:
            args['next_url'] = _dict['next_url']
        if 'total' in _dict:
...
class RuntimeEntity(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'entity' in _dict:
            ...
            raise ValueError(
                'Required property \'entity\' not present in RuntimeEntity dict'
            )
        if 'location' in _dict:
            ...
            raise ValueError(
                'Required property \'location\' not present in RuntimeEntity dict'
            )
        if 'value' in _dict:
            args['value'] = _dict['value']
            del xtra['value']
            ...
            raise ValueError(
                'Required property \'value\' not present in RuntimeEntity dict'
            )
...
class RuntimeIntent(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'intent' in _dict:
            ...
            raise ValueError(
                'Required property \'intent\' not present in RuntimeIntent dict'
            )
        if 'confidence' in _dict:
            args['confidence'] = _dict['confidence']
            del xtra['confidence']
            ...
            raise ValueError(
                'Required property \'confidence\' not present in RuntimeIntent dict'
            )
        args.update(xtra)
        return cls(**args)
...
class Synonym(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'synonym' in _dict:
            ...
            raise ValueError(
                'Required property \'synonym\' not present in Synonym dict')
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in Synonym dict')
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        else:
            raise ValueError(
                'Required property \'updated\' not present in Synonym dict')
        return cls(**args)
...
class SynonymCollection(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'synonyms' in _dict:
            ...
            raise ValueError(
                'Required property \'synonyms\' not present in SynonymCollection dict'
            )
        if 'pagination' in _dict:
            args['pagination'] = Pagination._from_dict(_dict['pagination'])
        else:
            raise ValueError(
                'Required property \'pagination\' not present in SynonymCollection dict'
            )
        return cls(**args)
...
class UpdateCounterexample(object):
    ...
    :attr str text: (optional) The text of the example to be marked as irrelevant input.
    """
    ...
    def __init__(self, text=None):
        ...
        :param str text: (optional) The text of the example to be marked as irrelevant input.
        """
        self.text = text
...
class UpdateDialogNode(object):
    ...
    :attr DialogNodeNextStep next_step: (optional) The next step to execute following this dialog node.
    :attr str title: (optional) The alias used to identify the dialog node.
    :attr str node_type: (optional) How the node is processed.
    :attr str event_name: (optional) How an `event_handler` node is processed.
    :attr str variable: (optional) The location in the dialog context where output is stored.
    :attr list[DialogNodeAction] actions: (optional) The actions for the dialog node.
    """
    ...
    def __init__(self,
        ...
        :param DialogNodeNextStep next_step: (optional) The next step to execute following this dialog node.
        :param str title: (optional) The alias used to identify the dialog node.
        :param str node_type: (optional) How the node is processed.
        :param str event_name: (optional) How an `event_handler` node is processed.
        :param str variable: (optional) The location in the dialog context where output is stored.
        :param list[DialogNodeAction] actions: (optional) The actions for the dialog node.
        """
    ...
    def _from_dict(cls, _dict):
        ...
        if 'dialog_node' in _dict:
            ...
            raise ValueError(
                'Required property \'dialog_node\' not present in UpdateDialogNode dict'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
        if 'conditions' in _dict:
...
class UpdateEntity(object):
    ...
    :attr str entity: (optional) The name of the entity.
    :attr str description: (optional) The description of the entity.
    :attr object metadata: (optional) Any metadata related to the entity.
    :attr bool fuzzy_match: (optional) Whether to use fuzzy matching for the entity.
    :attr list[CreateValue] values: (optional) An array of entity values.
    ...
    def __init__(self,
        ...
        :param str entity: (optional) The name of the entity.
        :param str description: (optional) The description of the entity.
        :param object metadata: (optional) Any metadata related to the entity.
        :param bool fuzzy_match: (optional) Whether to use fuzzy matching for the entity.
        :param list[CreateValue] values: (optional) An array of entity values.
...
class UpdateExample(object):
    ...
    :attr str text: (optional) The text of the user input example.
    """
    ...
    def __init__(self, text=None):
        ...
        :param str text: (optional) The text of the user input example.
        """
        self.text = text
...
class UpdateIntent(object):
    ...
    :attr str intent: (optional) The name of the intent.
    :attr str description: (optional) The description of the intent.
    ...
    def __init__(self, intent=None, description=None, examples=None):
        ...
        :param str intent: (optional) The name of the intent.
        :param str description: (optional) The description of the intent.
...
class UpdateSynonym(object):
    ...
    :attr str synonym: (optional) The text of the synonym.
    """
    ...
    def __init__(self, synonym=None):
        ...
        :param str synonym: (optional) The text of the synonym.
        """
        self.synonym = synonym
...
class UpdateValue(object):
    ...
    :attr str value: (optional) The text of the entity value.
    :attr object metadata: (optional) Any metadata related to the entity value.
    :attr list[str] synonyms: (optional) An array of synonyms for the entity value.
    """

    def __init__(self, value=None, metadata=None, synonyms=None):
        """
        Initialize a UpdateValue object.

        :param str value: (optional) The text of the entity value.
        :param object metadata: (optional) Any metadata related to the entity value.
        :param list[str] synonyms: (optional) An array of synonyms for the entity value.
        """
        self.value = value
...
class Value(object):
    ...
    def __init__(self, value_text, created, updated, metadata=None):
        """
    ...
    def _from_dict(cls, _dict):
        ...
        if 'value' in _dict:
            ...
            raise ValueError(
                'Required property \'value\' not present in Value dict')
        if 'metadata' in _dict:
            args['metadata'] = _dict['metadata']
        if 'created' in _dict:
            args['created'] = _dict['created']
            ...
            raise ValueError(
                'Required property \'created\' not present in Value dict')
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        else:
            raise ValueError(
                'Required property \'updated\' not present in Value dict')
        return cls(**args)
...
class ValueCollection(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'values' in _dict:
            ...
            raise ValueError(
                'Required property \'values\' not present in ValueCollection dict'
            )
        if 'pagination' in _dict:
            args['pagination'] = Pagination._from_dict(_dict['pagination'])
        else:
            raise ValueError(
                'Required property \'pagination\' not present in ValueCollection dict'
            )
        return cls(**args)
...
class ValueExport(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'value' in _dict:
            ...
            raise ValueError(
                'Required property \'value\' not present in ValueExport dict')
        if 'metadata' in _dict:
            args['metadata'] = _dict['metadata']
        if 'created' in _dict:
            args['created'] = _dict['created']
            ...
            raise ValueError(
                'Required property \'created\' not present in ValueExport dict'
            )
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        else:
            raise ValueError(
                'Required property \'updated\' not present in ValueExport dict'
            )
        if 'synonyms' in _dict:
            args['synonyms'] = _dict['synonyms']
        return cls(**args)
...
class Workspace(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError(
                'Required property \'name\' not present in Workspace dict')
        if 'language' in _dict:
            args['language'] = _dict['language']
        else:
            raise ValueError(
                'Required property \'language\' not present in Workspace dict')
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in Workspace dict')
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        else:
            raise ValueError(
                'Required property \'updated\' not present in Workspace dict')
        if 'workspace_id' in _dict:
            args['workspace_id'] = _dict['workspace_id']
        else:
            raise ValueError(
                'Required property \'workspace_id\' not present in Workspace dict'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
        if 'metadata' in _dict:
...
class WorkspaceCollection(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'workspaces' in _dict:
            ...
            raise ValueError(
                'Required property \'workspaces\' not present in WorkspaceCollection dict'
            )
        if 'pagination' in _dict:
            args['pagination'] = Pagination._from_dict(_dict['pagination'])
        else:
            raise ValueError(
                'Required property \'pagination\' not present in WorkspaceCollection dict'
            )
        return cls(**args)
...
class WorkspaceExport(object):
    ...
    def _from_dict(cls, _dict):
        ...
        if 'name' in _dict:
            ...
            raise ValueError(
                'Required property \'name\' not present in WorkspaceExport dict'
            )
        if 'description' in _dict:
            args['description'] = _dict['description']
        else:
            raise ValueError(
                'Required property \'description\' not present in WorkspaceExport dict'
            )
        if 'language' in _dict:
            args['language'] = _dict['language']
        else:
            raise ValueError(
                'Required property \'language\' not present in WorkspaceExport dict'
            )
        if 'metadata' in _dict:
            args['metadata'] = _dict['metadata']
        else:
            raise ValueError(
                'Required property \'metadata\' not present in WorkspaceExport dict'
            )
        if 'created' in _dict:
            args['created'] = _dict['created']
        else:
            raise ValueError(
                'Required property \'created\' not present in WorkspaceExport dict'
            )
        if 'updated' in _dict:
            args['updated'] = _dict['updated']
        else:
            raise ValueError(
                'Required property \'updated\' not present in WorkspaceExport dict'
            )
        if 'workspace_id' in _dict:
            args['workspace_id'] = _dict['workspace_id']
        else:
            raise ValueError(
                'Required property \'workspace_id\' not present in WorkspaceExport dict'
            )
        if 'status' in _dict:
            args['status'] = _dict['status']
        else:
            raise ValueError(
                'Required property \'status\' not present in WorkspaceExport dict'
            )
        if 'learning_opt_out' in _dict:
            args['learning_opt_out'] = _dict['learning_opt_out']
        else:
            raise ValueError(
                'Required property \'learning_opt_out\' not present in WorkspaceExport dict'
            )
        if 'intents' in _dict:
            args['intents'] = [
                IntentExport._from_dict(x) for x in _dict['intents']
