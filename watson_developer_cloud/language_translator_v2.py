...
class LanguageTranslatorV2(WatsonDeveloperCloudService):
    """Client for the Language Translator service."""
    ...
    def translate(self, text, model_id=None, source=None, target=None):
        ...
        :rtype: language_translator_v2.TranslationResult
        """
        if text is None:
        ...
        response = self.request(
            ...
            data=data,
            accept_json=True)
        return TranslationResult._from_dict(response)
    ...
    def identify(self, text):
        ...
        :return: A `IdentifiedLanguages` object
        :rtype: language_translator_v2.IdentifiedLanguages
        """
        if text is None:
            raise WatsonInvalidArgument('text must be provided')
        data = text
        ...
        response = self.request(
            ...
            data=data,
            accept_json=True)
        return IdentifiedLanguages._from_dict(response)
    ...
    def list_identifiable_languages(self):
        ...
        :return: A `IdentifiableLanguages` object
        :rtype: language_translator_v2.IdentifiableLanguages
        """
        response = self.request(
            method='GET', url='/v2/identifiable_languages', accept_json=True)
        return IdentifiableLanguages._from_dict(response)
    ...
    def create_model(self,
        ...
        :return: A `TranslationModel` object
        :rtype: language_translator_v2.TranslationModel
        """
        if base_model_id is None:
            raise WatsonInvalidArgument('base_model_id must be provided')
        ...
        response = self.request(
            ...
            accept_json=True)
        return TranslationModel._from_dict(response)
    ...
    def delete_model(self, model_id):
        ...
        """
        if model_id is None:
            raise WatsonInvalidArgument('model_id must be provided')
        response = self.request(
            method='DELETE',
    ...
    def list_models(self, source=None, target=None, default_models=None):
        ...
        :return: A `TranslationModels` object
        :rtype: language_translator_v2.TranslationModels
        """
        params = {'source': source, 'target': target, 'default': default_models}
        response = self.request(
            method='GET', url='/v2/models', params=params, accept_json=True)
        return TranslationModels._from_dict(response)
