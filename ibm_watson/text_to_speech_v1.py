...
Phonetic Representation (SPR). The Arabic, Chinese, Dutch, Australian English, and Korean
languages support only IPA.
    ...
    def synthesize(self,
        ...
        * All of the service's voices are now customizable and generally available (GA)
        ...
        :param str voice: (optional) The voice to use for synthesis. For more
               information about specifying a voice, see **Important voice updates** in
...
class CustomModel():
    ...
    :attr List[Word] words: (optional) An array of `Word` objects that lists the
          ...
          returned only by the **Get a custom model** method.
    :attr List[Prompt] prompts: (optional) An array of `Prompt` objects that
          ...
          field is returned only by the **Get a custom model** method.
    """
    ...
    def __init__(self,
        ...
        :param List[Word] words: (optional) An array of `Word` objects that lists
               ...
               custom model. This field is returned only by the **Get a custom model**
               method.
