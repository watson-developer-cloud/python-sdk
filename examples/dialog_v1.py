...
# print(json.dumps(dialog.get_dialog('6250d170-41d6-468a-a697-5675578c8012'),
#  indent=2))
...
# with open(join(dirname(__file__), '../resources/dialog.xml') as dialog_file:
#     print(json.dumps(dialog.update_dialog(dialog_file=dialog_file,
# dialog_id=dialog_id), indent=2))
...
#                                      dialog_input='What type of toppings do
#  you have?',
#                                      conversation_id=initial_response[
# 'conversation_id'],
# client_id=initial_response['client_id']), indent=2))

# print(json.dumps(dialog.delete_dialog(
# dialog_id='63b0489c-cd97-45ef-8800-4e7c310eeb19'), indent=2))

# print(json.dumps(dialog.update_profile(
#     dialog_id='6250d170-41d6-468a-a697-5675578c8012', client_id=123,
# name_values=[{'name': 'test', 'value': 'v1'}]),
#     indent=2))
#
