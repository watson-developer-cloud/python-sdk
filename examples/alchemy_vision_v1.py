...
# print(json.dumps(alchemy_vision.get_image_links(url='https://www.google.com')))
print(json.dumps(alchemy_vision.get_image_links(html='<a href=\"http://www.test.com/test.jpg\">foo</a>'), indent=2))
